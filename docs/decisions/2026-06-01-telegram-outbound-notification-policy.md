...
Turn progress, reasoning previews, command/control acknowledgements, history
replay, and other routine status output are silent. Final assistant output and
final agent attachments keep the default notify policy. Approval and
clarification prompts also notify because they require user action to unblock a
turn.
